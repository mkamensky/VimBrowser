...
" Last modified: Sun 20 Mar 2005 10:39:04 AM IST
" Description: short versions of commands. Part of browser plugin
...
" history
command! -bar -range=1 -bang Back <count>BrowserBack<bang>
command! -bar -range=1 -bang Pop <count>BrowserBack<bang>
command! -bar -range=1 -bang Forward <count>BrowserForward<bang>
command! -bar -range=1 -bang Tag <count>BrowserForward<bang>
command! -bar -bang Tags BrowserTags<bang>
