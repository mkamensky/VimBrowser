...
" Last modified: Sun 20 Mar 2005 11:25:32 AM IST
...
" opening
command! -bar -bang -nargs=* -complete=custom,BrowserCompleteBrowse Browse 
      \if strlen(<q-bang>) | 
      \  BrowserSideBar Browse <args> | 
      \else |
...
" history
command! -bar -range=1 -bang BrowserBack 
      \if strlen(<q-bang>) | 
      \  BrowserSideBar <count>BrowserBack <args> | 
      \else | 
      \  call BrowserBack(<count>) | 
      \endif
command! -bar -range=1 -bang BrowserPop <count>BrowserBack<bang>
command! -bar -range=1 -bang BrowserForward 
      \if strlen(<q-bang>) | 
      \  BrowserSideBar <count>BrowserForward <args> | 
      \else | 
      \  call BrowserForward(<count>) | 
      \endif
command! -bar -range=1 -bang BrowserTag <count>BrowserForward<bang>
command! -bar -bang BrowserTags 
      \if strlen(<q-bang>) | 
      \  BrowserSideBar BrowserTags <args> | 
      \else | 
      \  call BrowserHistory() | 
      \endif
